% kolm_langevin.m solves Kolmogorov's forward equation for the SDE 
% dX(t) = -X(t)dt + sigma * dB(t) with X(0)=0.
...
% The coefficients a, b, c are set here. 
  ...
  b = yc;                            % restoring drift
  c = ones(size(yc));                % derivative of drift for adjoint
...
% Evaluatate and display u(Tfixed).
  figure(2);
